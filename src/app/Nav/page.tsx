...
//             </div>
//           </div>
//           <div className="flex  text-white  h-10  gap-4">
//             <div className=" border-[1px] rounded-[50%] px-2 py-2 border-[#f5b754] justify-center items-center flex ">
//               <PhoneCall />
//             </div>
  ...
  return (
    <div className="bg-transparent w-full py-2 md:py-8 lg:py-6">
      <div className="items-center lg:items-center justify-between  text-white flex gap-24 py-6 px-4 md:px-3 lg:px-36  w-full  lg:w-[1440px] mx-auto md:py-0 ">
        ...
        <div className="flex w-full text-white h-10 gap-4">
          <div className=" border-[1px] rounded-[50%] px-2 py-2 border-[#f5b754] justify-center items-center flex ">
            <PhoneCall />
          </div>
          <div className="flex w-full justify-between flex-col ">
            <h1 className="text-xs w-full"> Need Help?</h1>
            <a className="w-full text-[17px]" href="tel:855 100 4444">855 100 4444</a>
          </div>
        </div>
      </div>
    </div>
