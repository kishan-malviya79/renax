        ...
        <div className="  w-full py-28 ">
          <div className=" relative items-center  justify-center content-center  text-white flex   lg:px-36 w-full lg:w-[1440px] mx-auto md:py-0">
            <div className="  items-center flex flex-col gap-4">
              <h5 className=" size-5 relative sm:right-3 w-[18ch] text-[#f5b754] tracking-[6px] text-[12px]">
                {" "}
                RENT NOW
              </h5>
              ...
              <div className=" w-[356px] md:w-full lg:w-full     bg-[#222] gap-3  flex flex-col  h-[492px] sm:h-auto  sm:flex-row  px-6 py-6 items-center rounded-3xl lg:rounded-full ">
                <Menubar className=" gap-8 sm:gap-6   flex flex-col  h-[400px] lg:h-auto w-full md:flex-col lg:flex-row">
                  <MenubarMenu>
                    <MenubarTrigger className=" w-full  px-2 sm:px-0 relative sm:w-[17ch]   justify-between flex ">
                      Choose Car Type{" "}
                      <ChevronDown className=" size-5 relative  text-[#f5b754] " />{" "}
                    </MenubarTrigger>
                    <MenubarContent className="  w-[320px] right-2 relative sm:w-full  ">
                      <MenubarItem className="  flex items-center  sm:justify-start justify-center">
                        Choose Car Type
                      </MenubarItem>
                      <MenubarItem className="  flex items-center  sm:justify-start justify-center">
                        All
                  ...
                  <MenubarMenu>
                    <MenubarTrigger className=" w-full  px-2 sm:px-0 relative sm:w-[17ch]   justify-between flex">
                      Pick Up Date
                      <LucideCalendarRange className=" size-4 relative  text-[#f5b754] " />{" "}
                    </MenubarTrigger>
                    <MenubarContent className="  w-[320px] right-2 relative sm:w-full  ">
                      <MenubarItem className="  flex items-center  sm:justify-start justify-center">
                        Car Grid
                  ...
                  <MenubarMenu>
                    <MenubarTrigger className=" w-full  px-2 sm:px-0 relative sm:w-[17ch]   justify-between flex">
                      Return Date
                      <LucideCalendarRange className="size-4  text-[#f5b754]  relative right-3" />{" "}
                    </MenubarTrigger>
                    <MenubarContent className="  w-[320px] right-2 relative sm:w-full  ">
                      <MenubarItem className="  flex items-center  sm:justify-start justify-center">
                        {" "}
