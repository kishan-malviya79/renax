...
function Rentax() {
  return (
    <div className="bg-[#1b1b1b] py-12 md:py-28">
      <div className="container md:px-36 px-6 lg:px-36 lg:w-[1440px] md:gap-8 flex flex-col lg:flex-row md:items-center items-center justify-between text-white">
        ...
        <div className=" flex flex-col w-full gap-4">
          ...
          <h1 className="font-Outfit font-bold  md:text-4xl text-4xl lg:text-4xl">We Are More Than</h1>
          <h1 className="text-3xl md:text-4xl lg:text-4xl leading-8 text-[#f5b754] font-bold">A Car Rental Company</h1>
          <p className="max-w-prose text-xs md:w-[95ch] lg:text-sm opacity-50 leading-7">Car repair quisque sodales dui ut varius vestibulum drana tortor turpis porttiton tellus eu euismod nisl massa nutodio in the miss volume place urna lacinia eros nunta urna mauris vehicula rutrum in the miss on volume interdum. </p>
        ...
        <div className="flex  relative mt-6 md:mt-0">
          <Image
            ...
            height="500"  
            width="500"
            className="object-contain rounded-tl-3xl rounded-tr-3xl w-[360px]  md:w-[720px] lg:w-[700px] rounded-bl-none rounded-br-3xl transition-transform duration-300 transform hover:-scale-x-100 "
          />
