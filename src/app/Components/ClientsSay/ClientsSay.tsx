    ...
    return (
        <div className="w-full pt-44  bg-[#1b1b1b]">
            <div className="w-full">
                 <div className='relative items-center justify-center gap-8 md:gap-12  leading-7 flex-col text-white flex lg:px-36 w-full md:w-[720px] lg:w-[1440px] mx-auto md:py-0'>
                    <div className="">
