...
function ClientsSay() {
    ...
    return (
        <div className="w-full pt-44 h-screen bg-[#1b1b1b]">
                    ...
                    <Carousel opts={{ align: "start" }} className='w-full'>
                        <CarouselContent className="-ml-1">
                            <div className="md:basis-1/2  flex gap-6 text-white lg:basis-1/3">
                                ...
                                <div className="flex flex-col bg-[#222222] rounded-tl-3xl rounded-tr-3xl rounded-bl-none rounded-br-3xl p-12 gap-4 pl-10 h-80 w-90 relative">
                                    <div className="absolute top-4 left-0 w-[85px] h-[85px] text-center rounded-tl-none rounded-tr-lg">
