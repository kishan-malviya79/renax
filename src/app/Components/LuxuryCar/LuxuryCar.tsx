...
const LuxuryCar: React.FC = () => {
  return (
    <div className="bg-red-600 text-white overflow-hidden w-full">
      <div className="w-full  md:h-screen bg-[#1b1b1b]">
            ...
            {carDetails.map((car, index) => (
              <CarouselItem key={index} className="md:basis-1/2 text-white lg:basis-1/3">
                <Image
                  ...
                  height={1100}
                  width={1100}
                  className="object-contain relative left-2 sm:left-0 rounded-2xl w-[360px]  sm:w-full"
                />
                <div className="relative -top-7 px-4 py-6 rounded-2xl sm:items-center flex sm:flex-row flex-col justify-between gap-3 sm:gap-0 bg-[#222] mx-3">
